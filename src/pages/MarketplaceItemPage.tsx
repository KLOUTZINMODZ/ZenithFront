  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-12 gap-4 sm:gap-6 lg:gap-8">
        {}
        <div className="bg-gray-800 relative rounded-xl sm:rounded-2xl overflow-hidden border border-gray-700 order-first lg:col-span-8 lg:order-none w-full">
        ...
        {galleryImages.length > 1 && (
          <div className="flex justify-center gap-2 order-first lg:col-span-8 lg:order-none w-full">
