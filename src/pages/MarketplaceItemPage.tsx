    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 lg:gap-8">
        ...
        <div className="lg:col-span-8 space-y-4 sm:space-y-6 order-3 lg:order-1">
          ...
          {}
          <div className="bg-gray-800 rounded-xl p-4 sm:p-6 order-4 lg:order-none">
          ...
          {}
          {hasAdditionalInfo && (
            <div className="bg-gray-800 rounded-xl p-4 sm:p-6 space-y-4 order-4 lg:order-none">
        ...
        {}
        <div className="lg:col-span-4 space-y-4 sm:space-y-6 lg:sticky lg:top-6 self-start order-2 lg:order-2">
          {}
          <div className="bg-gray-800 rounded-xl p-4 sm:p-6 order-1 lg:order-none">
          ...
          {}
          <div className="bg-gray-800 rounded-xl p-6 order-5 lg:order-none">
      ...
      {relatedItems.length > 0 && (
        <div className="mt-12 order-6 lg:order-none">
